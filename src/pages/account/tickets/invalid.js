        ...
        return(
            <div className="white-bg">
                ...
                <div className="padding-sm bg-body">
                    <Flex className="ticket-list invalid-list red-border padding white-bg margin-bottom-sm">
                        ...
                        <Button className="yellow-bg btn-sm full" type="primary">续期</Button>
                        </div>
                        
                    </Flex>
                    <Flex className="ticket-list invalid-list purple-border padding white-bg margin-bottom-sm">
                        <div className="flex-left">
                        ...
                        <img alt="" className="invalid-icon" src={require("assets/images/account/tickets_1.png")} />
                    </Flex>
                    <Flex className="ticket-list invalid-list blue-border padding white-bg margin-bottom-sm">
                        <div className="flex-left">
                        ...
                        <img alt="" className="invalid-icon" src={require("assets/images/account/tickets_2.png")} />
                    </Flex>
                </div>
